...
class FileContainer extends React.Component {
    ...
    render() {
        return (
            <div>
                {this.props.parentDocument.props.parentDoc.state.fileEditorWindow && <FileContentContainer ref={f => (this.fileContentContainer = f)} parentDocument={this} fileData={this.props.fileData}/>}
