	...
	render() {
		return (
			<div style={{ height: 'calc(100% - 5px)', width: '100%' }}>
				<DataGrid id="grid" width="100%" height="100%" enableCopy="true" enableExport="true" styleName="gridStyle" horizontalScrollPolicy="auto" footerDrawTopBorder="true" enableEagerDraw="true">
