	...
	render() {
		return (
			<div style={{ height: 'calc(100% - 1px)', width: '100%' }}>
				<DataGrid ref={g => (this.grid = g)} dataProvider={this.props.remitsPLB} enableExportAll={true} id="grid" width="100%" height="100%" enableCopy="true" enableExport="true" styleName="gridStyle" horizontalScrollPolicy="auto" footerDrawTopBorder="true" enableEagerDraw="true" pagerRenderer={MontefioreUtils.pagerFactory}>
