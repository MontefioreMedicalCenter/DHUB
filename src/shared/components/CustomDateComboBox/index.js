...
export default class CustomDateComboBox extends DateComboBox {
	constructor(props) {
		super(props)
		this.setDateRangeOptions([DateRange.DATE_RANGE_LAST_24_HOURS, DateRange.DATE_RANGE_LAST_7_DAYS, DateRange.DATE_RANGE_THISWEEK, DateRange.DATE_RANGE_THISMONTH, DateRange.DATE_RANGE_THISQUARTER, DateRange.DATE_RANGE_THISYEAR, DateRange.DATE_RANGE_CUSTOM])
	...
	onClick(e) {
		...
		if (si && si[this.dataField] === DateRange.DATE_RANGE_CUSTOM) {
			...
			const actions = [ToolbarAction.create('OK', this.onDatePicker, true), ToolbarAction.create(Constants.MCS_BTN_CANCEL_LABEL, this.onDatePickerCancel.bind(this), true)]
