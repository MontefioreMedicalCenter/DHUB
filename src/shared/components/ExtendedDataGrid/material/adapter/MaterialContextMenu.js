...
export default class MaterialContextMenu extends UIComponent {
	...
	addPopup(elem, onContextMenuCreated) {
		return <ContextMenuPopup children={elem} onContextMenuCreated={onContextMenuCreated} />
	}
...
MaterialContextMenu.prototype.typeName = MaterialContextMenu.typeName = 'MaterialContextMenu' //for quick inspection
...
MaterialContextMenu.ACTION_COPY_SELECTED_RECORDS = Constants.COPY_SELECTED_RECORDS
