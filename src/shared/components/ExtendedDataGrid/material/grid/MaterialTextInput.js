...
export default class MaterialTextInput extends TextInput {
	...
	clear() {
		this._value = ''
		this.children = [<TextField style={{ width: this.percentWidth || '100%' }} value={''} onChange={this.handleChange} />]
		this.requestRender()
	}
	getValue() {
		return this._value || ''
	...
	handleChange(e) {
		...
		this.children = [<TextField style={{ width: this.percentWidth || '100%' }} value={this._value} onChange={this.handleChange} />]
