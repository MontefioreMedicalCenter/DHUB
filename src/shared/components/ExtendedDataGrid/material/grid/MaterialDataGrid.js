import { ReactDataGrid, UIUtils, FlexDataGridColumnLevel, ClassFactory } from '../../../../../flexicious'
import '../styles.css'
...
export default class MaterialDataGrid extends ReactDataGrid {
	...
	setColumns(val) {
		...
		for (const col of val) {
			...
			const check = col._headerText === 'Topic' || col._headerText === 'Presentation/Material' || col._headerText === 'Lesson' || col._headerText === 'Lesson Element'
