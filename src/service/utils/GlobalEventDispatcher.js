...
GlobalEventDispatcher.prototype.typeName = GlobalEventDispatcher.typeName = 'GlobalEventDispatcher'

GlobalEventDispatcher._instance = null

GlobalEventDispatcher.instance = () => {
	if (!GlobalEventDispatcher._instance) GlobalEventDispatcher._instance = new GlobalEventDispatcher()
